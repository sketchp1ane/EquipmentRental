...
{
    /// <inheritdoc />
    public partial class AddInspectionItemResult : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InspectionItemResults_InspectionRecords_InspectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InspectionItemResults_InspectionId_ItemKey",
                table: "InspectionItemResults",
                columns: new[] { "InspectionId", "ItemKey" },
                unique: true);
        }
